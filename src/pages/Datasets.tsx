    ...
    <div className="py-12 px-6 min-h-screen bg-[#F8F9FB]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-semibold text-[#30345E] mb-4">Marine Datasets</h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-[#30345E] focus:ring-2 focus:ring-[#30345E]/10"
                value={searchTerm}
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                className="px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-[#30345E] bg-white"
                value={selectedType}
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#F8F9FB]">
                <tr>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Dataset Name</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Type</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Source</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Upload Date</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Size</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Records</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#30345E]">Actions</th>
                </tr>
              </thead>
                ...
                {filteredDatasets.map((dataset, index) => (
                  <tr key={index} className="hover:bg-[#F8F9FB] transition-colors duration-200">
                    <td className="px-6 py-4">
                      <div className="font-medium text-[#1A1A1A] font-mono text-sm">{dataset.name}</div>
                    </td>
                    <td className="px-6 py-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        dataset.type === 'Ocean' ? 'bg-blue-100 text-blue-800' :
                        dataset.type === 'Fisheries' ? 'bg-green-100 text-green-800' :
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-2">
                        <button 
                          ...
                          className="p-2 text-[#30345E] hover:bg-[#30345E] hover:text-white rounded-lg transition-all duration-200"
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-2xl font-semibold text-[#30345E]">Dataset Details</h2>
                <button 
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#30345E]">Name</h3>
                  <p className="text-gray-700">{selectedDataset.name}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#30345E]">Type</h3>
                  <p className="text-gray-700">{selectedDataset.type}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#30345E]">Source</h3>
                  <p className="text-gray-700">{selectedDataset.source}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#30345E]">Upload Date</h3>
                  <p className="text-gray-700">{selectedDataset.uploadDate}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#30345E]">Size</h3>
                  <p className="text-gray-700">{selectedDataset.size}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#30345E]">Records</h3>
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  <button 
                    ...
                    className="bg-gray-100 text-[#30345E] px-4 py-2 rounded-lg hover:bg-gray-200 transition-all duration-200"
                  >
                    Copy Citation
                  </button>
                </div>
