...
import { MapPin, Layers, BarChart3, TrendingUp, Filter, Download, Eye, ToggleLeft, ToggleRight, Grid, Table, Map } from 'lucide-react';
      ...
      <div className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-semibold text-[#30345E] mb-4">Marine Data Visualization</h1>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 mb-6">
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center space-x-2">
                <Filter className="w-4 h-4 text-[#30345E]" />
                <span className="text-sm font-medium text-[#30345E]">Filters:</span>
              </div>
              
              <select
                value={selectedFishType}
                onChange={(e) => setSelectedFishType(e.target.value)}
                className="px-3 py-1 border border-gray-200 rounded-md text-sm focus:outline-none focus:border-[#30345E]"
              >
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  {compareMode ? (
                    <ToggleRight className="w-5 h-5 text-[#30345E]" />
                  ) : (
                  ...
                  {['dataset1', 'dataset2', 'dataset3'].map(dataset => (
                    <label key={dataset} className="flex items-center space-x-1">
                      <input
                        ...
                        className="rounded border-gray-300 text-[#30345E] focus:ring-[#30345E]"
                      />
          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3 space-y-6">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-gray-100">
                      <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-[#30345E]">Indian Ocean Marine Map</h2>
                        <div className="flex items-center space-x-2">
                          <Layers className="w-5 h-5 text-[#30345E]" />
                          <span className="text-sm font-medium text-[#30345E]">Layers</span>
                        </div>
                      </div>
                        ...
                        {['temperature', 'salinity', 'currents', 'species'].map((layer) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                              activeLayer === layer
                                ? 'bg-[#30345E] text-white'
                                : 'bg-gray-100 text-gray-600 hover:bg-[#30345E] hover:text-white'
                            }`}
                          >
                    ...
                    <div className="p-6 border-t border-gray-100 bg-[#F8F9FB]">
                      <div className="grid md:grid-cols-3 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-[#30345E] mb-2">
                          ...
                          <input
                            ...
                            className="w-full accent-[#30345E]"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-[#30345E] mb-2">
                          ...
                          <div className="flex space-x-2">
                            <input
                              ...
                              className="flex-1 accent-[#30345E]"
                            />
                            <input
                              type="range"
                              min="5"
                        ...
                        <div className="flex items-end">
                          <button className="bg-[#30345E] text-white px-4 py-2 rounded-lg hover:scale-105 transition-all duration-200 flex items-center space-x-2">
              ...
              {viewMode === 'chart' && (
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-[#30345E]">Species Richness Over Time</h3>
                      <Download className="w-4 h-4 text-[#30345E] cursor-pointer hover:scale-110 transition-transform" onClick={() => downloadChart('species-richness')} />
                    </div>
                    <ResponsiveContainer width="100%" height={250}>
                      <LineChart data={speciesRichnessData}>
                        ...
                        <Tooltip />
                        <Line type="monotone" dataKey="richness" stroke="#3C7EDB" strokeWidth={2} dot={{ r: 4 }} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-[#30345E]">Fish Distribution by Region</h3>
                      <Download className="w-4 h-4 text-[#30345E] cursor-pointer hover:scale-110 transition-transform" onClick={() => downloadChart('fish-distribution')} />
                    </div>
                    <ResponsiveContainer width="100%" height={250}>
                      <BarChart data={fishDistributionData}>
                        ...
                        <Tooltip />
                        <Bar dataKey="tuna" fill="#30345E" />
                        <Bar dataKey="cod" fill="#3C7EDB" />
                        <Bar dataKey="salmon" fill="#60A5FA" />
                        <Bar dataKey="mackerel" fill="#93C5FD" />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-[#30345E]">Depth vs Biodiversity</h3>
                      <Download className="w-4 h-4 text-[#30345E] cursor-pointer hover:scale-110 transition-transform" onClick={() => downloadChart('depth-biodiversity')} />
                    </div>
                    <ResponsiveContainer width="100%" height={250}>
                      <ScatterChart data={biodiversityScatterData}>
                        ...
                        <Scatter dataKey="biodiversity" fill="#3C7EDB" />
                      </ScatterChart>
                    </ResponsiveContainer>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-[#30345E]">Temperature vs Species</h3>
                      <Download className="w-4 h-4 text-[#30345E] cursor-pointer hover:scale-110 transition-transform" onClick={() => downloadChart('temperature-species')} />
                    </div>
                    <ResponsiveContainer width="100%" height={250}>
                      <BarChart data={temperatureSpeciesData}>
                        ...
                        <YAxis tick={{ fontSize: 10 }} />
                        <Tooltip />
                        <Bar dataKey="species" fill="#3C7EDB" />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
              ...
              {viewMode === 'table' && (
                <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                  <div className="p-6 border-b border-gray-100">
                    <h3 className="text-lg font-semibold text-[#30345E]">Species Data Table</h3>
                  </div>
                    ...
                    <table className="w-full">
                      <thead className="bg-[#F8F9FB]">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left text-sm font-semibold text-[#30345E]">Count</th>
                          <th className="px-4 py-3 text-left text-sm font-semibold text-[#30345E]">Region</th>
                          <th className="px-4 py-3 text-left text-sm font-semibold text-[#30345E]">Depth (m)</th>
                          <th className="px-4 py-3 text-left text-sm font-semibold text-[#30345E]">Temperature (°C)</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-100">
                        {topSpeciesData.map((species, index) => (
                          <tr key={index} className="hover:bg-[#F8F9FB] transition-colors duration-200">
                            <td className="px-4 py-3 font-medium text-[#30345E]">{species.species}</td>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                  <h3 className="text-lg font-semibold text-[#30345E] mb-4">Top Species</h3>
                    ...
                    {topSpeciesData.slice(0, 3).map((species, index) => (
                      <div key={species.species} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-[#30345E] font-mono text-xs">{species.percentage}%</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                  <h3 className="text-lg font-semibold text-[#30345E] mb-4">Most Abundant Fish Types</h3>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                  <h3 className="text-lg font-semibold text-[#30345E] mb-4">Temperature vs Species</h3>
                  <ResponsiveContainer width="100%" height={150}>
                    <LineChart data={temperatureSpeciesData}>
                      <XAxis dataKey="temp" tick={{ fontSize: 10 }} />
                      <YAxis tick={{ fontSize: 10 }} />
                      <Tooltip />
                      <Line type="monotone" dataKey="species" stroke="#3C7EDB" strokeWidth={2} dot={{ r: 3 }} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-[#30345E]">Species Richness</h3>
                  <Download className="w-4 h-4 text-[#30345E] cursor-pointer hover:scale-110 transition-transform" onClick={() => downloadChart('species-richness')} />
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-[#30345E]">Fish Distribution</h3>
                  <BarChart3 className="w-4 h-4 text-[#30345E]" />
                </div>
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={fishDistributionData}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-[#30345E]">Depth vs Biodiversity</h3>
                  <TrendingUp className="w-4 h-4 text-[#30345E]" />
                </div>
                <ResponsiveContainer width="100%" height={200}>
                  <ScatterChart data={biodiversityScatterData}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
