...
For complete documentation, visit our online portal.`;
  ...
  const renderEndpoint = (endpoint) => (
    <div key={endpoint.endpoint} className="bg-[#F8F9FB] rounded-lg p-4 mb-4">
      <div className="flex items-center space-x-2 mb-3">
        ...
        <code className="bg-white px-3 py-1 rounded font-mono text-sm text-[#30345E]">
      ...
      {endpoint.request && (
        <div className="mb-3">
          <h4 className="text-sm font-semibold text-[#30345E] mb-2">Request Body:</h4>
      ...
      <div>
        <h4 className="text-sm font-semibold text-[#30345E] mb-2">Response:</h4>
        <div className="bg-white rounded border p-3 relative group">
    ...
    <div className="py-12 px-6 min-h-screen bg-[#F8F9FB]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-semibold text-[#30345E] mb-4">API Documentation</h1>
              ...
              {tabs.map(({ id, label, icon: Icon }) => (
                <button
                  ...
                  className={`flex items-center space-x-2 py-2 px-1 border-b-2 font-medium text-sm whitespace-nowrap transition-all duration-200 ${
                    activeTab === id
                      ? 'border-[#30345E] text-[#30345E]'
                      : 'border-transparent text-gray-500 hover:text-[#30345E] hover:border-[#30345E]'
                  }`}
                >
          ...
          <div className="p-6">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-semibold text-[#30345E] mb-4">Getting Started</h2>
                  <div className="prose max-w-none">
                    ...
                    <div className="bg-[#F8F9FB] rounded-lg p-4 mb-6">
                      <h3 className="font-semibold text-[#30345E] mb-2">Base URL</h3>
                    ...
                    <div className="bg-[#F8F9FB] rounded-lg p-4 mb-6">
                      <h3 className="font-semibold text-[#30345E] mb-2">Authentication</h3>
                      <p className="text-gray-700 mb-2">Include your API key in the Authorization header:</p>
                      <code className="bg-white px-3 py-1 rounded font-mono text-sm block">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-6">
                      <div className="bg-[#F8F9FB] rounded-lg p-4">
                        <h3 className="font-semibold text-[#30345E] mb-2">Rate Limits</h3>
                      ...
                      <div className="bg-[#F8F9FB] rounded-lg p-4">
                        <h3 className="font-semibold text-[#30345E] mb-2">Response Format</h3>
                        <ul className="text-gray-700 text-sm space-y-1">
                ...
                <div className="flex items-center justify-center">
                  <button 
                    ...
                    className="bg-[#30345E] text-white px-6 py-3 rounded-lg hover:scale-105 transition-all duration-200 flex items-center space-x-2"
                  >
            ...
            {activeTab === 'datasets' && (
              <div>
                <h2 className="text-2xl font-semibold text-[#30345E] mb-6">Datasets API</h2>
            ...
            {activeTab === 'species' && (
              <div>
                <h2 className="text-2xl font-semibold text-[#30345E] mb-6">Species Identification API</h2>
                <p className="text-gray-700 mb-6">
            ...
            {activeTab === 'edna' && (
              <div>
                <h2 className="text-2xl font-semibold text-[#30345E] mb-6">Environmental DNA API</h2>
                <p className="text-gray-700 mb-6">
            ...
            {activeTab === 'geospatial' && (
              <div>
                <h2 className="text-2xl font-semibold text-[#30345E] mb-6">Geospatial API</h2>
                <p className="text-gray-700 mb-6">
                  Access location-based marine data and spatial analysis tools.
                </p>
                <div className="bg-[#F8F9FB] rounded-lg p-8 text-center">
                  <Map className="w-12 h-12 text-[#30345E] mx-auto mb-3" />
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-sm p-6">
          <h2 className="text-2xl font-semibold text-[#30345E] mb-4">SDK Examples</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-[#30345E] mb-3">JavaScript/Node.js</h3>
...
console.log(datasets);`}</code>
            ...
            <div>
              <h3 className="text-lg font-medium text-[#30345E] mb-3">Python</h3>
              <div className="bg-gray-900 rounded-lg p-4 text-green-400 font-mono text-sm">
